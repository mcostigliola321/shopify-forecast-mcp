...
- [x] 07-02-PLAN.md — `.github/workflows/publish.yml` (wait-for-ci + build + PyPI OIDC + multi-arch GHCR + GitHub Release with CHANGELOG body) (Wave 2)
- [x] 07-03-PLAN.md — Multistage Dockerfile + docker-entrypoint.sh + .dockerignore (Wave 2, parallel with 07-02)
- [x] 07-04-PLAN.md — Documentation suite: README rewrite, CHANGELOG [0.1.0], SETUP.md, ARCHITECTURE.md (3 mermaid diagrams), TOOLS.md (generated + enriched) (Wave 2, parallel with 07-02 + 07-03)
- [x] 07-05-PLAN.md — Release runbook (docs/RELEASE.md) + v0.1.0-rc1 4-leg dry-run + v0.1.0 tag cut (Wave 3, depends on 07-02, 07-03, 07-04; has human-action checkpoints)
